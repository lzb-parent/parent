...
public enum EnumAuthDict implements IEnumAuthDict,  IEnumToDbEnum<AuthDict> {
    ...
    FRONT_API("前端接口地址","http://localhost:8153/api",SYSTEM_CONFIG, textarea,true,null,null,null,"多个请用逗号隔开_每个域名后面需要加上杠api",null,6,null),
    APP_DOWNLOAD_OPEN("app下载开关", "1", SYSTEM_CONFIG, bool, true, null, null, null, null, null, 7, null),
    APP_DOWNLOAD_BTN_GONE_SECOND("app下载消失时间", "0", SYSTEM_CONFIG, bool, true, null, null, null, "设置为负一则一直显示", null, 8, null),
...
//    DEV_UI_ADMIN_PATH("开发工具_本地ui_admin源码根目录绝对路径", "/Users/zubin/projectnew/snowball/snowball-ui-admin/src/parent-ui-admin", null, text, null, null, null, null, null, null, null, null),
    DEV_PROJECT_ROOT_PATH("开发工具_本地项目根目录", "", null, text, null, null, null, null, null, null, null, null),

    // 用户端配置 USER_SITE_CONFIG
    USER_SITE_CONFIG("用户端配置", "", null, text, false, null, null, null, null, null, 1, null),
    SYSTEM_NOTICE("系统公告", "This is system notice", USER_SITE_CONFIG, textarea, true, null, "", false, "站点系统公告_显示在首页公告位置", null, null, null),
    SERVICE_ONLINE("在线客服链接", "https://t.me/xxxxxxx", USER_SITE_CONFIG, text, true, null, "", false, "例如：https://t.me/xxxx", null, null, null),//例如： https://t.me/xxxx
    ...
    COMMISSION_ACCOUNT_OPEN("佣金账户开关", "0", COMMISSION_CONFIG, bool, true, null, null, null, "打开后_启用佣金账户功能", null, 100, null),
    ...
    REGISTER_PHONE_PATTERN("手机号正则表达式", "", REGISTER_CONFIG, bool, true, null, null, null, "例如_^09\\d{9}$_09开头的11位数", null, null, null),
    ...
    REGISTER_PROPS_REQUIRE("注册属性必填", "", REGISTER_CONFIG, select, true, null, "EnumRegisterProps", true, "注册必填属性", null, null, null),
    REGISTER_CODE_LETTERS_USER("注册用户推荐码字母", "0123456789", REGISTER_CONFIG, select, true, null, "EnumRegisterProps", true, " 比如数字或字母_123456789ABCDEFGHIJKLMNPQRSTUVWXYZ", null, null, null),
    REGISTER_CODE_LETTERS_AGENT("注册代理推荐码字母", "0123456789", REGISTER_CONFIG, select, true, null, "EnumRegisterProps", true, "", null, null, null),
    REGISTER_USERNAME_FROM("注册默认用户名来源", "INPUT", REGISTER_CONFIG, select, true, null, "EnumRegisterUsernameFrom", false, "注册时_平台唯一的username取自什么字段", null, null, null),
